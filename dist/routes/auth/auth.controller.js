        ...
        switch (_a.label) {
            case 0:
                ...
                if (!username || !firstname || !lastname || !password) {
                    throw new globalErrorHandler_1.CustomError(400, "All fields required");
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!username || !password) {
                    return [2 /*return*/, next(new globalErrorHandler_1.CustomError(400, 'All fields required'))];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
            ...
            case 2:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, next(new globalErrorHandler_1.CustomError(400, 'Invalid credential'))];
                }
